...
const rows = [
    { id: 'regno', numeric: false, disablePadding: true, label: 'Reg No' },
                        ...
                        <TableBody>
                            {stableSort(userlist, getSorting(order, orderBy))
                                ...
                                .map(x => {
                                    ...
                                    return (
                                        <TableRow hover
                                            onClick={event => this.handleClick(event, x.id)}
                                            role="checkbox"
                                        ...
                                        >
                                            ...
                                            <TableCell component="th" scope="row" padding="none">  {x.regno}</TableCell>
